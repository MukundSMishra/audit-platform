...
// Enums (copied from contractAuditTypes.ts for JSX compatibility)
const CheckStatus = {
  PASS: 'PASS',
  FAIL: 'FAIL',
...
const ContractAuditWizard = ({ factoryName, location, onBack }) => {
  // Initial State
  ...
  useEffect(() => {
    ...
    Object.values(auditState.checklists).forEach((section) => {
  ...
  // --- 4. HANDLERS ---
  const handleChecklistChange = (sectionKey, questionId, field, value) => {
    setAuditState(prev => {
      const currentSection = prev.checklists?.[sectionKey] || {};
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="w-64 bg-white border-r shadow-sm p-6">
        <h2 className="text-xl font-bold text-gray-800 mb-2">Business Risk Audit</h2>
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow p-8">
            ...
            <div className="space-y-6">
              {activeSection.questions.map((q) => {
                ...
                const itemState = auditState.checklists?.[activeSection.key]?.[q.id] || {};
